            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="edit-post.php">All Post</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="add-post.php">New Post</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="tag.php">Tag</a></li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="nav-menus.php">Menus</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
